...
class BehaviorTab(QWidget):
    ...
    def setup_camera(self):
        ...
        try:
            ...
            if not self.camera:
                QMessageBox.warning(self, "Camera Error", "No working camera found. Please connect a camera.")
                return False
            ...
            QMessageBox.critical(self, "Camera Setup Error", f"Could not initialize camera: {str(e)}")
            return False
    ...
    def toggle_monitoring(self):
        ...
        if self.monitoring:
            ...
            if not self.emotion_detector:
                QMessageBox.warning(self, "Emotion Detection", "Emotion detection is not available.")
    ...
    def record_behavior(self, emotion, confidence):
        ...
        try:
            # In a real-world scenario, you'd associate this with a specific student and class
