...
class AnalyticsTab(QWidget):
    ...
    def generate_behavior_report(self, class_id, start_date, end_date):
        ...
        if not data:
            self.ax.text(0.5, 0.5, "No behavior data available", 
                        ha='center', va='center')
            return
        ...
        sns.barplot(data=df, x='behavior_type', y='count', 
                   hue='behavior_value', ax=self.ax)
    ...
    def generate_emotion_report(self, class_id, start_date, end_date):
        ...
        if not data:
            self.ax.text(0.5, 0.5, "No emotion data available", 
                        ha='center', va='center')
            return
    ...
    def generate_engagement_report(self, class_id, start_date, end_date):
        ...
        if not data:
            self.ax.text(0.5, 0.5, "No engagement data available", 
                        ha='center', va='center')
            return
        ...
        sns.barplot(data=df, y='name', x='engagement_count', 
                   orient='h', ax=self.ax)
